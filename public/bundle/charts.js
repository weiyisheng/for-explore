...
var LineCom = React.createClass({displayName: "LineCom",
    ...
    render: function () {
        ...
        return (
            React.createElement("canvas", {className: "myCanvas"})
        )
    }
});

var BarCom = React.createClass({displayName: "BarCom",
...
var RadarCom = React.createClass({displayName: "RadarCom",
...
var PolarCom = React.createClass({displayName: "PolarCom",
...
var PieCom = React.createClass({displayName: "PieCom",
...
var ChartsCom = React.createClass({displayName: "ChartsCom",

    render: function () {


        return (
            React.createElement("div", {className: "full-width full-height"}, 
                React.createElement(LineCom, null), 
                React.createElement(BarCom, null), 
                React.createElement(RadarCom, null), 
                React.createElement(PolarCom, null), 
                React.createElement(PieCom, null)
            )
        )
    }
});

React.render(React.createElement(ChartsCom, null), document.body);

},{"chart.js":2,"react":157}]},{},[158]);
